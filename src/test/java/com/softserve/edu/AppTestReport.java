...
public class AppTestReport {
	...
	public void tearDown(ITestResult result) throws Exception {
		...
		if (!result.isSuccess()) {
			Reporter.log("<BR><BR><FONT SIZE='4' COLOR='BLUE'>ALARM TEST FAIL "
					+ result.getName() 
					+ "</FONT><BR>", true);
			Reporter.log("<br><p>Screenshot</p>");
			takeScreenShot();
			//Reporter.log("<br><p><a href='d:\\screenshot.png'>Source Code</a> filename is d:\\Screenshot.png</p>");	
			Reporter.log("<br><div><image style=\"max-width:90%%\" src=\"d:\\Screenshot.png\"  alt=\"could not take screen shot\" /></div>");
			// Add Screenshot, etc.
		}
	}
